...
// Smooth scroll specifically to Book Now
function scrollToBookNow(e) {
  e.preventDefault();
  const el = document.getElementById('book-now');
  if (!el) return;
  const HEADER_OFFSET = 110; // header + announcement bar
    ...
    <div className="sticky top-0 z-50 border-b border-white/10 backdrop-blur bg-black/40">
      <Section className="py-3 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-6 text-white/80">
          <a href="#book-now" onClick={scrollToBookNow} className="hover:text-white">About</a>
          <a
...
export default function FixNowSite() {
  return (
    <main id="top" className="min-h-screen w-full scroll-smooth" style={{ background: BRAND.colors.dark }}>
      ...
      {/* Services */}
      <Section id="services" className="py-12 sm:py-16 scroll-mt-24">
          ...
          {[{
            ...
            <div key={i} className="rounded-2xl overflow-hidden border border-white/10 bg-white/5">
              ...
              <div className="p-5 text-white">
                ...
                <div className="mt-4 flex items_center justify-between">
      ...
      {/* Service areas */}
      <Section id="areas" className="py-12 sm:py-16 scroll-mt-24">
      ...
      {/* Reviews */}
      <Section className="py-12 sm:py-16 scroll-mt-24">
      ...
      {/* Book now (Contact) */}
      <Section id="book-now" className="py-12 sm:py-16 scroll-mt-24">
      ...
      <footer className="border-t border-white/10">
        <Section className="py-10 text-white/70">
          <div className="flex flex-col md:flex-row items-start md:items-center justify_between gap-4">
            <div>
